...
public class l_account_k_settingsGoalsNutritionWater extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_k_settingsGoalsNutritionWater() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("water_container"));
        solo.sleep(1000);
