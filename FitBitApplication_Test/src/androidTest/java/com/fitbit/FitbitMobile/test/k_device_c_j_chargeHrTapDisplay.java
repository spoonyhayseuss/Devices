...
public class k_device_c_j_chargeHrTapDisplay extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public k_device_c_j_chargeHrTapDisplay() throws ClassNotFoundException {
