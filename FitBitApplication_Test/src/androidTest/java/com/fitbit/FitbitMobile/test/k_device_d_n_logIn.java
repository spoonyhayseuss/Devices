...
public class k_device_d_n_logIn extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public k_device_d_n_logIn() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.enterText((android.widget.EditText) solo.getView("login_email"), "flexonezip@android.com");
        //Sleep for x milliseconds
        solo.sleep(2000);
        //screenshot
        ...
        solo.enterText((android.widget.EditText) solo.getView("login_password"), "flexonezip");
        //Sleep for x milliseconds
        solo.sleep(2000);
        //screenshot
