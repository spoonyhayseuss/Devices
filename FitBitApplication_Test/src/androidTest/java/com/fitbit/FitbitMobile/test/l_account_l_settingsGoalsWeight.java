...
public class l_account_l_settingsGoalsWeight extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_l_settingsGoalsWeight() throws ClassNotFoundException {
