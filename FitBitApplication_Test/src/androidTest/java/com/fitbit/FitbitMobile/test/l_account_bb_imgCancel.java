...
public class l_account_bb_imgCancel extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_bb_imgCancel() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        //solo.clickOnText(java.util.regex.Pattern.quote("CANCEL"));
        //Click on Cancel
