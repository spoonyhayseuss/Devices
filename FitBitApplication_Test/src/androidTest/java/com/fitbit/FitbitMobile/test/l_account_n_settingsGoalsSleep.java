...
public class l_account_n_settingsGoalsSleep extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_n_settingsGoalsSleep() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnText(java.util.regex.Pattern.quote("Sleep"));
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("sleep_container"));
        solo.sleep(1000);
