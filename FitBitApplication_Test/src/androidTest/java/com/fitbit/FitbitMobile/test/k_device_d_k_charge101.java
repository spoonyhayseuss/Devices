...
public class k_device_d_k_charge101 extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public k_device_d_k_charge101() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        //Sleep for x milliseconds
        solo.sleep(2000);
        //Click on UPDATE AVAILABLE Charge HR Last synced: 46 mins ago RelativeLayout
        ...
        //Sleep for x milliseconds
        solo.sleep(2000);
        //Click on Charge HR 101 Guide Learn about your Charge HR
        ...
        //Sleep for x milliseconds
        solo.sleep(2000);
        //Click on Caring tips
        solo.clickOnWebElement(By.textContent("Call Notifications"));
        solo.sleep(1000);
        solo.takeScreenshot("");
    }
}
