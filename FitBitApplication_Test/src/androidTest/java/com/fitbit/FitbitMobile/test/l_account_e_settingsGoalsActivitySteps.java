...
public class l_account_e_settingsGoalsActivitySteps extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_e_settingsGoalsActivitySteps() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("steps_container"));
        solo.sleep(1000);
        solo.clearEditText(0);
        solo.enterText(0, "400");
