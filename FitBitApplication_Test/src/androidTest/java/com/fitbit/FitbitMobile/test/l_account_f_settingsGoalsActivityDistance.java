...
public class l_account_f_settingsGoalsActivityDistance extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_f_settingsGoalsActivityDistance() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("distance_container"));
        solo.sleep(1000);
