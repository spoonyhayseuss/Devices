...
public class l_account_m_settingsGoalsBodyFat extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_m_settingsGoalsBodyFat() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("body_fat_container"));
        solo.sleep(1000);
