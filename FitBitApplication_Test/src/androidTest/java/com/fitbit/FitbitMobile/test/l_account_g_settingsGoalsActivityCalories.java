...
public class l_account_g_settingsGoalsActivityCalories extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_g_settingsGoalsActivityCalories() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("calories_container"));
        solo.sleep(1000);
        solo.clearEditText(0);
        solo.enterText(0, "3000");
