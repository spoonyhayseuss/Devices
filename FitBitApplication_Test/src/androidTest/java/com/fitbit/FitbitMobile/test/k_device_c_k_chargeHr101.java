...
public class k_device_c_k_chargeHr101 extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public k_device_c_k_chargeHr101() throws ClassNotFoundException {
	...
	public void testRun() {
		...
		solo.clickOnWebElement(By.textContent("Caring tips"));
	}
}
