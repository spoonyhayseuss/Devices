...
public class l_account_i_settingsGoalsActivityFloors extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public l_account_i_settingsGoalsActivityFloors() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(1000);
        solo.clickOnView(solo.getView("floors_container"));
        solo.sleep(1000);
